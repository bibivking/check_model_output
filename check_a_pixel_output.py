...
if __name__ == "__main__":
    case_name = "ERAI_gw_off"
    path = "/g/data/w35/mm3972/model/wrf/NUWRF/LISWRF_configs/%s/LIS_output/" % case_name
    input_fname = [path+"LIS.CABLE.2018010100.d01.nc",path+"LIS.CABLE.2018020100.d01.nc",
                   ...
                   path+"LIS.CABLE.2018110100.d01.nc"
                   ] # ,path+"LIS.CABLE.2018120100.d01.nc",
